...
while running:
    ...
    pygame.draw.rect(screen,WHITE, (200,50,50,50))  #2
    pygame.draw.rect(screen, WHITE, (300,50,150,50)) #3
    pygame.draw.rect(screen,WHITE, (100,200,50,50)) #4
    pygame.draw.rect(screen,WHITE, (200,200,50,50)) #5
    pygame.draw.rect(screen,WHITE, (300,150,150,50)) #6

    screen.blit(text_1,(115,45))
    screen.blit(text_2,(215,45))
    screen.blit(text_3,(330,45))
    screen.blit(text_4,(115,195))
    screen.blit(text_5,(215,195))
